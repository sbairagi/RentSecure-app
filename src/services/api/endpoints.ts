...
export const API_ENDPOINTS = {
  ...
  RENTERS: {
    LIST: '/api/renters/',
    DETAIL: (id: string) => `/api/renters/${id}/`,
    CREATE: '/api/renters/',
    UPDATE: (id: string) => `/api/renters/${id}/`,
    DELETE: (id: string) => `/api/renters/${id}/`,
    VERIFY: (id: string) => `/api/renters/${id}/verify/`,
    BLACKLIST: (id: string) => `/api/renters/${id}/blacklist/`,
    HISTORY: (id: string) => `/api/renters/${id}/history/`,
