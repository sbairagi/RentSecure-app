...
export const NOTIFICATION_TYPE_CONFIG: Record<NotificationType, {
  ...
  visitor_approval: { label: 'Visitor Approval', icon: '👤', color: '#059669', defaultPriority: 'medium' },
  subscription_expiry: { label: 'Subscription Expiry', icon: '⏰', color: '#DC2626', defaultPriority: 'high' },
  feature_limit_warning: { label: 'Feature Limit Warning', icon: '⚠️', color: '#D97706', defaultPriority: 'medium' },
  system_announcement: { label: 'System Announcement', icon: '📢', color: '#6B7280', defaultPriority: 'medium' },
